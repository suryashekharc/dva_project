...
function ready(stateData, usMap) {
    ...
    switch (graph_type) {
        case 0:
            ...
            break;
        case 1:
            d3.select("#national_graph").style("visibility", "hidden");
            drawStateGraph(stateData)
            break;
        case 2:
            d3.select("#national_graph").style("visibility", "hidden");
...
function createNationalGraph(stateData) {
    d3.select("#national_graph").style("visibility", "visible");
    ...
    container2.append("g")
        ...
        .attr("height", ((2 * temp_height) / sortedStateData.length - 5))
        .attr("fill", "#ff1493")
        .attr("transform", "translate(100," + (0) + ")");

    container2.append("g")
        .attr("class", "national_graph_axis")
        .attr("transform", "translate(100," + (2 * temp_height) + ")")
        .attr("id", "x-axis-bars")
        .call(xbar_axis);
